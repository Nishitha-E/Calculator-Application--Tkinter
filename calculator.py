...
class Calculator:
    def __init__(self, master):
        ...
        # Entry field
        Entry(master, width=17, bg="violet", font=('Arial Bold', 28), textvariable=self.equation).place(x=0, y=0)
        ...
        Button(master, width=11, height=4, text='=', relief='flat', bg='violet', command=self.solve).place(x=270, y=350)
